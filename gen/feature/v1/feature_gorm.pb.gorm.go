...
type ServiceRolesORM struct {
	CratedAt  *time.Time
	DeletedAt *time.Time
	Id        uint64        `gorm:"primaryKey;not null"`
	Roles     []*v1.RoleORM `gorm:"foreignKey:Id;references:Id;many2many:service_roles_roles;joinForeignKey:ServiceRolesId;joinReferences:RoleId"`
	Services  []*ServiceORM `gorm:"foreignKey:Id;references:Id;many2many:service_roles_services;joinForeignKey:ServiceRolesId;joinReferences:ServiceId"`
	UpdatedAt *time.Time
}

// TableName overrides the default tablename generated by GORM
func (ServiceRolesORM) TableName() string {
	return "services_roles"
}

// ToORM runs the BeforeToORM hook if present, converts the fields of this
// object to ORM format, runs the AfterToORM hook, then returns the ORM object
func (m *ServiceRoles) ToORM(ctx context.Context) (ServiceRolesORM, error) {
	to := ServiceRolesORM{}
	var err error
	if prehook, ok := interface{}(m).(ServiceRolesWithBeforeToORM); ok {
		if err = prehook.BeforeToORM(ctx, &to); err != nil {
			return to, err
		}
	}
	...
	for _, v := range m.Services {
		if v != nil {
			if tempServices, cErr := v.ToORM(ctx); cErr == nil {
				to.Services = append(to.Services, &tempServices)
			} else {
				return to, cErr
			}
		} else {
			to.Services = append(to.Services, nil)
		}
	}
	if m.CratedAt != nil {
		t := m.CratedAt.AsTime()
	...
	if posthook, ok := interface{}(m).(ServiceRolesWithAfterToORM); ok {
		err = posthook.AfterToORM(ctx, &to)
	}
	return to, err
}
...
// ToPB runs the BeforeToPB hook if present, converts the fields of this
// object to PB format, runs the AfterToPB hook, then returns the PB object
func (m *ServiceRolesORM) ToPB(ctx context.Context) (ServiceRoles, error) {
	to := ServiceRoles{}
	var err error
	if prehook, ok := interface{}(m).(ServiceRolesWithBeforeToPB); ok {
		if err = prehook.BeforeToPB(ctx, &to); err != nil {
			return to, err
		}
	}
	...
	for _, v := range m.Services {
		if v != nil {
			if tempServices, cErr := v.ToPB(ctx); cErr == nil {
				to.Services = append(to.Services, &tempServices)
			} else {
				return to, cErr
			}
	...
	if posthook, ok := interface{}(m).(ServiceRolesWithAfterToPB); ok {
		err = posthook.AfterToPB(ctx, &to)
	}
	return to, err
}
...
// The following are interfaces you can implement for special behavior during ORM/PB conversions
// of type ServiceRoles the arg will be the target, the caller the one being converted from

// ServiceRolesBeforeToORM called before default ToORM code
type ServiceRolesWithBeforeToORM interface {
	BeforeToORM(context.Context, *ServiceRolesORM) error
}

// ServiceRolesAfterToORM called after default ToORM code
type ServiceRolesWithAfterToORM interface {
	AfterToORM(context.Context, *ServiceRolesORM) error
}

// ServiceRolesBeforeToPB called before default ToPB code
type ServiceRolesWithBeforeToPB interface {
	BeforeToPB(context.Context, *ServiceRoles) error
}

// ServiceRolesAfterToPB called after default ToPB code
type ServiceRolesWithAfterToPB interface {
	AfterToPB(context.Context, *ServiceRoles) error
}
...
// DefaultCreateServiceRoles executes a basic gorm create call
func DefaultCreateServiceRoles(ctx context.Context, in *ServiceRoles, db *gorm.DB) (*ServiceRoles, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeCreate_); ok {
		if db, err = hook.BeforeCreate_(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithAfterCreate_); ok {
		if err = hook.AfterCreate_(ctx, db); err != nil {
			return nil, err
		}
	}
...
type ServiceRolesORMWithBeforeCreate_ interface {
	BeforeCreate_(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithAfterCreate_ interface {
	AfterCreate_(context.Context, *gorm.DB) error
}

func DefaultReadServiceRoles(ctx context.Context, in *ServiceRoles, db *gorm.DB) (*ServiceRoles, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeReadApplyQuery); ok {
		if db, err = hook.BeforeReadApplyQuery(ctx, db); err != nil {
			return nil, err
		}
	}
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeReadFind); ok {
		if db, err = hook.BeforeReadFind(ctx, db); err != nil {
			return nil, err
		}
	}
	ormResponse := ServiceRolesORM{}
	if err = db.Where(&ormObj).First(&ormResponse).Error; err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormResponse).(ServiceRolesORMWithAfterReadFind); ok {
		if err = hook.AfterReadFind(ctx, db); err != nil {
			return nil, err
		}
	}
...
type ServiceRolesORMWithBeforeReadApplyQuery interface {
	BeforeReadApplyQuery(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithBeforeReadFind interface {
	BeforeReadFind(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithAfterReadFind interface {
	AfterReadFind(context.Context, *gorm.DB) error
}

func DefaultDeleteServiceRoles(ctx context.Context, in *ServiceRoles, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	ormObj, err := in.ToORM(ctx)
	...
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeDelete_); ok {
		if db, err = hook.BeforeDelete_(ctx, db); err != nil {
			return err
		}
	}
	err = db.Where(&ormObj).Delete(&ServiceRolesORM{}).Error
	if err != nil {
		return err
	}
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithAfterDelete_); ok {
		err = hook.AfterDelete_(ctx, db)
	}
	return err
}

type ServiceRolesORMWithBeforeDelete_ interface {
	BeforeDelete_(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithAfterDelete_ interface {
	AfterDelete_(context.Context, *gorm.DB) error
}

func DefaultDeleteServiceRolesSet(ctx context.Context, in []*ServiceRoles, db *gorm.DB) error {
	if in == nil {
		return errors.NilArgumentError
	}
	var err error
	...
	if hook, ok := (interface{}(&ServiceRolesORM{})).(ServiceRolesORMWithBeforeDeleteSet); ok {
		if db, err = hook.BeforeDeleteSet(ctx, in, db); err != nil {
			return err
		}
	}
	err = db.Where("id in (?)", keys).Delete(&ServiceRolesORM{}).Error
	if err != nil {
		return err
	}
	if hook, ok := (interface{}(&ServiceRolesORM{})).(ServiceRolesORMWithAfterDeleteSet); ok {
		err = hook.AfterDeleteSet(ctx, in, db)
	}
	return err
}

type ServiceRolesORMWithBeforeDeleteSet interface {
	BeforeDeleteSet(context.Context, []*ServiceRoles, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithAfterDeleteSet interface {
	AfterDeleteSet(context.Context, []*ServiceRoles, *gorm.DB) error
}

// DefaultStrictUpdateServiceRoles clears / replaces / appends first level 1:many children and then executes a gorm update call
func DefaultStrictUpdateServiceRoles(ctx context.Context, in *ServiceRoles, db *gorm.DB) (*ServiceRoles, error) {
	if in == nil {
		return nil, fmt.Errorf("Nil argument to DefaultStrictUpdateServiceRoles")
	}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	lockedRow := &ServiceRolesORM{}
	db.Model(&ormObj).Set("gorm:query_option", "FOR UPDATE").Where("id=?", ormObj.Id).First(lockedRow)
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeStrictUpdateCleanup); ok {
		if db, err = hook.BeforeStrictUpdateCleanup(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	ormObj.Roles = nil
	if err = db.Model(&ormObj).Association("Services").Replace(ormObj.Services); err != nil {
		return nil, err
	}
	ormObj.Services = nil
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeStrictUpdateSave); ok {
		if db, err = hook.BeforeStrictUpdateSave(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithAfterStrictUpdateSave); ok {
		if err = hook.AfterStrictUpdateSave(ctx, db); err != nil {
			return nil, err
		}
	}
...
type ServiceRolesORMWithBeforeStrictUpdateCleanup interface {
	BeforeStrictUpdateCleanup(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithBeforeStrictUpdateSave interface {
	BeforeStrictUpdateSave(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithAfterStrictUpdateSave interface {
	AfterStrictUpdateSave(context.Context, *gorm.DB) error
}

// DefaultPatchServiceRoles executes a basic gorm update call with patch behavior
func DefaultPatchServiceRoles(ctx context.Context, in *ServiceRoles, updateMask *field_mask.FieldMask, db *gorm.DB) (*ServiceRoles, error) {
	if in == nil {
		return nil, errors.NilArgumentError
	}
	var pbObj ServiceRoles
	var err error
	if hook, ok := interface{}(&pbObj).(ServiceRolesWithBeforePatchRead); ok {
		if db, err = hook.BeforePatchRead(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	pbReadRes, err := DefaultReadServiceRoles(ctx, &ServiceRoles{Id: in.GetId()}, db)
	if err != nil {
		return nil, err
	}
	pbObj = *pbReadRes
	if hook, ok := interface{}(&pbObj).(ServiceRolesWithBeforePatchApplyFieldMask); ok {
		if db, err = hook.BeforePatchApplyFieldMask(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	if _, err := DefaultApplyFieldMaskServiceRoles(ctx, &pbObj, in, updateMask, "", db); err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&pbObj).(ServiceRolesWithBeforePatchSave); ok {
		if db, err = hook.BeforePatchSave(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
	pbResponse, err := DefaultStrictUpdateServiceRoles(ctx, &pbObj, db)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(pbResponse).(ServiceRolesWithAfterPatchSave); ok {
		if err = hook.AfterPatchSave(ctx, in, updateMask, db); err != nil {
			return nil, err
		}
	}
...
type ServiceRolesWithBeforePatchRead interface {
	BeforePatchRead(context.Context, *ServiceRoles, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesWithBeforePatchApplyFieldMask interface {
	BeforePatchApplyFieldMask(context.Context, *ServiceRoles, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesWithBeforePatchSave interface {
	BeforePatchSave(context.Context, *ServiceRoles, *field_mask.FieldMask, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesWithAfterPatchSave interface {
	AfterPatchSave(context.Context, *ServiceRoles, *field_mask.FieldMask, *gorm.DB) error
}

// DefaultPatchSetServiceRoles executes a bulk gorm update call with patch behavior
func DefaultPatchSetServiceRoles(ctx context.Context, objects []*ServiceRoles, updateMasks []*field_mask.FieldMask, db *gorm.DB) ([]*ServiceRoles, error) {
	if len(objects) != len(updateMasks) {
		return nil, fmt.Errorf(errors.BadRepeatedFieldMaskTpl, len(updateMasks), len(objects))
	}

	results := make([]*ServiceRoles, 0, len(objects))
	for i, patcher := range objects {
		pbResponse, err := DefaultPatchServiceRoles(ctx, patcher, updateMasks[i], db)
		if err != nil {
			return nil, err
		}
...
// DefaultApplyFieldMaskServiceRoles patches an pbObject with patcher according to a field mask.
func DefaultApplyFieldMaskServiceRoles(ctx context.Context, patchee *ServiceRoles, patcher *ServiceRoles, updateMask *field_mask.FieldMask, prefix string, db *gorm.DB) (*ServiceRoles, error) {
	if patcher == nil {
		return nil, nil
	} else if patchee == nil {
		return nil, errors.NilArgumentError
...
// DefaultListServiceRoles executes a gorm list call
func DefaultListServiceRoles(ctx context.Context, db *gorm.DB) ([]*ServiceRoles, error) {
	in := ServiceRoles{}
	ormObj, err := in.ToORM(ctx)
	if err != nil {
		return nil, err
	}
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeListApplyQuery); ok {
		if db, err = hook.BeforeListApplyQuery(ctx, db); err != nil {
			return nil, err
		}
	}
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithBeforeListFind); ok {
		if db, err = hook.BeforeListFind(ctx, db); err != nil {
			return nil, err
		}
	}
	...
	if hook, ok := interface{}(&ormObj).(ServiceRolesORMWithAfterListFind); ok {
		if err = hook.AfterListFind(ctx, db, &ormResponse); err != nil {
			return nil, err
		}
	}
	pbResponse := []*ServiceRoles{}
	for _, responseEntry := range ormResponse {
		temp, err := responseEntry.ToPB(ctx)
		if err != nil {
			return nil, err
...
type ServiceRolesORMWithBeforeListApplyQuery interface {
	BeforeListApplyQuery(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithBeforeListFind interface {
	BeforeListFind(context.Context, *gorm.DB) (*gorm.DB, error)
}
type ServiceRolesORMWithAfterListFind interface {
	AfterListFind(context.Context, *gorm.DB, *[]ServiceRolesORM) error
}
